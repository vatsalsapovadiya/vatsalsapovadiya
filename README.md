...
Passionate **Security Operations Center Analyst** with expertise in threat detection, incident response, and security automation. I specialize in hunting advanced persistent threats and building automated security workflows to protect critical infrastructure.

**🔍 Core Competencies:**
- **Threat Detection & Analysis** - SIEM correlation, behavioral analytics, anomaly detection
- **Incident Response** - Rapid containment, forensic analysis, remediation following NIST frameworks
- **Malware Analysis** - Static/dynamic analysis, reverse engineering, IoC extraction
- **Security Automation** - Python scripting, PowerShell, SOAR playbook development
- **Threat Intelligence** - OSINT collection, IoC correlation, MITRE ATT&CK mapping

**🎯 Current Focus:**
- Advanced persistent threat (APT) detection and analysis
- Building custom YARA rules for malware detection
- Automating incident response workflows with SOAR
- Developing proactive threat hunting playbooks
...
![IBM QRadar](https://img.shields.io/badge/IBM_QRadar-054ADA?style=flat&logo=ibm&logoColor=white)
...
- **Kill Chain** - Threat analysis methodology
